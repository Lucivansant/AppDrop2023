...
<body>
    ...
    <section id="seg-geral" style="font-family: 'Chivo Mono', monospace;">
        <div class="container" id="div-sec-geral">
            <div id="div-sec">
                <p id="boas-vindas"><i class="fa-solid fa-screwdriver-wrench"></i> Servidor em manutenção... Tente novamente mais tarde. </p>
                <img src="../../imgs/Double Ring-1s-200px.png" width="10px" alt="" id="text-card">
            </div>
