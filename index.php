...
<body>
    ...
    <section id="seg-geral" style="font-family: 'Chivo Mono', monospace;">
        <div class="container" id="div-sec">
            <i class="fa-brands fa-shopify" id="boas-vindas"></i>
            <p>Seja bem vindo outlier!!</p>
        </div>
        <nav class="navbar fixed-bottom bg-body-tertiary">
            <div class="container-fluid">
                <div id="menu-bottom">
                    <a href="./Private/views/Projetar.php"><i class="fa-solid fa-gauge-high" id="icons"></i></a>
